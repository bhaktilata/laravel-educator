...
class Page extends Model {
    ...
    use Sluggable;
    protected $fillable = ['title', 'title_seo', 'slug', 'author', 'image', 'thumbnail', 'annotation', 'description', 'keywords', 'content', 'user_id', 'category_id', 'visible', 'hits', 'is_featured', 'rating']; // разрешение массовой загрузки полей формы
