            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="reward-list mt-5">
                        <div class="reward-item">
                            <div class="reward-item-photo"><img src="{{ asset('assets/front/images/banner.png')}}" alt="" class="img-fluid"></div>
                        ...
                        <div class="reward-item">
                            <div class="reward-item-photo"><img src="{{ asset('assets/front/images/skills.png')}}" alt="" class="img-fluid"></div>
                            <div class="reward-item-detail">
                ...
                <div class="col-lg-6 align-self mt-lg-0 mt-md-5 mt-4">
                    <div class="position-relative px-lg-5 mx-lg-0 mx-md-5 image-padding">
                        <img src="{{ asset('assets/front/images/awards.png')}}" alt="" class="radius-image img-fluid">
                        <div class="position-absolute-images">
                            <img src="{{ asset('assets/front/images/award.png')}}" class="img-fluid pos-img" alt="" />
                            <img src="{{ asset('assets/front/images/award1.png')}}" class="img-fluid pos-img1" alt="" />
                            <img src="{{ asset('assets/front/images/award2.png')}}" class="img-fluid pos-img2" alt="" />
                        </div>
                    </div>
                </div>
            </div>
