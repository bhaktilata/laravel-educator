        ...
        <div class="container py-lg-5 py-md-3">
            <div class="row">
                ...
                <div class="col-lg-6 align-self text-center mt-lg-0 mt-md-5 mt-4">
                    <div class="images">
                        <img src="{{ asset('assets/front/images/client1.png')}}" class="img-fluid" alt="" />
                        <img src="{{ asset('assets/front/images/client2.png')}}" class="img-fluid" alt="" />
                        <img src="{{ asset('assets/front/images/client3.png')}}" class="img-fluid" alt="" />
                        <img src="{{ asset('assets/front/images/client4.png')}}" class="img-fluid" alt="" />
                        <img src="{{ asset('assets/front/images/client5.png')}}" class="img-fluid" alt="" />
                        <img src="{{ asset('assets/front/images/client2.png')}}" class="img-fluid" alt="" />
                        <img src="{{ asset('assets/front/images/client3.png')}}" class="img-fluid" alt="" />
                        <img src="{{ asset('assets/front/images/client4.png')}}" class="img-fluid" alt="" />
                        <img src="{{ asset('assets/front/images/client5.png')}}" class="img-fluid" alt="" />
