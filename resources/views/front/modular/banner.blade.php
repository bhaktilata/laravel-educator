<section class="bannerw3l-hnyv">
        <div class="banner-layer">
            <video autoplay="" muted="" loop="" id="myVideo">
                <source src="{{ asset('public/assets/front/images/line-edu.mp4')}}" type="video/mp4">
            ...
            <div class="main-content-top">
                <div class="container">
                    <div class="main-content">
                        ...
                        <a href="eb/about.html" class="btn btn-style transparant-btn mt-md-5 mt-4">Read More</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="apply-admission-wrap">
                <div class="apply-admission-inner">
                    ...
                    <div class="apply-form">
                        <form action="/web/index.html#" class="" method="post">
