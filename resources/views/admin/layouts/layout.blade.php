...
<head>
  ...
  <title>Артстудия INICONS | Панель администратора</title>
  <!-- Google Font: Source Sans Pro -->
  <link rel="icon" type="image/png" href="{{ asset('public/assets/admin/img/favicon.ico')}}"> 
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ url('/') }}" class="nav-link">Домой</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ url('front.feedback') }}" class="nav-link">Обратная связь</a>
      </li>
...
<!-- //Main Sidebar Container -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020-2021 <a href="https://attractionspace.ru">Attractionspace</a></strong> | All rights reserved.
  </footer>
...
<script src="{{ asset('public/assets/admin/plugins/bs-custom-file-input/bs-custom-file-input.min.js') }}"></script>
...
@include('admin.particle.wrapper')
</body>
</html>
